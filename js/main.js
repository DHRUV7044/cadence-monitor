            ...
            card.innerHTML = `
                ...
                <div class="card-meta">
                    ...
                    <div class="card-meta-item">
                        ...
                        <span>Checked: ${formattedDate}</span>
                    </div>
                </div>
            `;
        ...
        document.getElementById("status-container").innerHTML = `
            <div class="card" style="grid-column: 1 / -1; align-items: center; text-align: center;">
                <div class="card-header-area" style="margin-bottom: 10px;">
                    <h2 style="color: var(--status-offline);">Load Failure</h2>
                </div>
                <p class="message">Unable to query live telemetry from diagnostic nodes.</p>
            </div>
        `;
    }
}
